...
caffe('reset')
prototxt_file = './model/DeepPose/deeppose_stage2.prototxt';
caffemodel_file = './model/DeepPose/deeppose_iter_60000.caffemodel';
caffe('set_mode_cpu');
caffe('init', prototxt_file, caffemodel_file, 'test');
%%
input_data = h5read( './output/FLIC_pose_Stage2_test/FLIC_pose_part_1.h5','/data');
